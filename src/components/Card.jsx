...
export const Card = ({ prod: { imgSrc, title, price } }) => {
  return (
    <div className="max-w-sm bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
      <img className="p-8 rounded-t-lg" src={imgSrc} alt="product" />
      <div className="px-5 pb-5">
        <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white h-12">
          {title}
        </h5>
        ...
        <span className="text-3xl font-bold text-gray-900 dark:text-white text-left">
          RS. {price}
        </span>
